...
class MainActivity : ComponentActivity() {
    ...
    fun GalleryPreview() {
        ...
        var indexPhoto by remember { mutableIntStateOf(0) } // Estado para armazenar o índice da foto
        ...
        AthGalleryTheme {
            Column(
                ...
                Row(
                    ...
                    Button(onClick = {
                        indexPhoto=
                            if (indexPhoto - 1 < 0) artsRepository.size() - 1 // Caso Especial: O primeiro item da lista
                            else  (indexPhoto - 1) % artsRepository.size() // Caso Base
                    },
                    ...
                    Button(onClick = {
                        indexPhoto = (indexPhoto + 1) % artsRepository.size()
                    },
                        modifier = Modifier.weight(1f)
                            .padding(horizontal = 8.dp)
                            .height(48.dp) // Ajusta a altura do botão
                        ) {
                        Text(text = "Next",
                            fontSize = 20.sp)
                    }
